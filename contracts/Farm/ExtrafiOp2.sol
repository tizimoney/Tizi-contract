...
interface ISwapRouter is ISharedStructs {
...
contract ExtrafiOp2 is Ownable, IFarm {
    address public vault;
    address public staking = 0x85E6cCf15EA3f4BDC4569fDE3BB8bCa432F7A38e;
    ...
    address public opFeed = 0x0D276FC14719f9292D5C1eA2198673d1f4269246;
    address public usdcFeed = 0x16a9FA2FDa030272Ce99B29CF780dFA30361E0f3;
    ...
    function swap(
        ...
        if (bal > 0) {
            ...
            emit SwapTokenToUSDC(_token, USDCBalAfter - USDCBalBefore);
        }
    }
