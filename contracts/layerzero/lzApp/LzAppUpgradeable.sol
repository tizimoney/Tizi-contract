    ...
    ILayerZeroUserApplicationConfig
{
    ...
    bytes32 private constant LzAppStorageLocation =
        0x111388274dd962a0529050efb131321f60015c2ab1a99387d94540f430037b00;
    ...
    function minDstGasLookup(
        uint16 dstChainId,
        uint16 packetType
    ) external view returns (uint256 minGas) {
        LzAppStorage storage $ = _getLzAppStorage();
     ...
     */
    function payloadSizeLimitLookup(
        uint16 dstChainId
    ...
    function _checkGasLimit(
        ...
        require(
            providedGasLimit >= minGasLimit + extraGas,
